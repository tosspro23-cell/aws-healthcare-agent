...
``agent.py`` re-verifies the returned text with
``safety.run_safety_checks``, falling back to the mock narrator if it
fails any check regardless of what fed the prompt.
"""
